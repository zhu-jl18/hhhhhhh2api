...
<head>
    ...
    <title>Highlight AI API - Vercel Edge Functions</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>OpenAI 兼容的 AI API 代理</p>
            <div class="platform-badge">⚡ Powered by Vercel Edge Functions</div>
        </div>
        ...
        <div style="text-align: center; margin-top: 40px; padding: 20px; border-top: 1px solid #e5e5e7;">
            <div style="color: #6e6e73; font-size: 14px; margin-bottom: 8px;">
                项目开源 · 由 <strong>三文鱼</strong> 开发 · Vercel Edge Functions 版本
            </div>
